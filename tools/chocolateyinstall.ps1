...
$url        = 'https://www.fiinote.com/pub/appdownload.jsp?os=2' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'FiiNote*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
